...
#include <memory>
#include "../../../../Code/SolverControl/SolverControlerBase.h"
...
QT_MOC_LITERAL(13, 150, 12), // "removeSolver"
QT_MOC_LITERAL(14, 163, 16), // "readSolverOutput"
QT_MOC_LITERAL(15, 180, 15), // "processFinished"
QT_MOC_LITERAL(16, 196, 8), // "exitCode"
QT_MOC_LITERAL(17, 205, 20), // "QProcess::ExitStatus"
QT_MOC_LITERAL(18, 226, 10), // "exitStatus"
QT_MOC_LITERAL(19, 237, 10) // "stopSolver"
    ...
    "w\0proID\0removeSolver\0readSolverOutput\0"
    "processFinished\0exitCode\0QProcess::ExitStatus\0"
    "exitStatus\0stopSolver"
};
...
static const uint qt_meta_data_SolverControl__SolverControlBase[] = {
 ...
 // slots: name, argc, parameters, tag, flags
      ...
      15,    2,   72,    2, 0x09 /* Protected */,
      19,    1,   77,    2, 0x09 /* Protected */,
...
void SolverControl::SolverControlBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->removeSolver((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->readSolverOutput(); break;
        case 6: _t->processFinished((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QProcess::ExitStatus(*)>(_a[2]))); break;
        case 7: _t->stopSolver((*reinterpret_cast< QWidget*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (SolverControlBase::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SolverControlBase::removeSolver)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void SolverControl::SolverControlBase::removeSolver(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
