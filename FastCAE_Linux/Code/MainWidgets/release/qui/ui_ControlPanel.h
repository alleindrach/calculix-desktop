...
public:
    ...
    void setupUi(QDockWidget *ControlPanel)
    {
        ...
        label->setStyleSheet(QString::fromUtf8("color: rgb(18,145,243);\n"
"font: 10pt \"Arial\";\n"
""));
        ...
        verticalLayout_5->addLayout(propLayout);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 421, 204));
    ...
    void retranslateUi(QDockWidget *ControlPanel)
    {
        ...
        label->setText(QCoreApplication::translate("ControlPanel", "Settings", nullptr));
