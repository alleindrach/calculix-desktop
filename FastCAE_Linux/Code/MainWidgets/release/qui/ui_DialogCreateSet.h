...
public:
    ...
    void setupUi(QDialog *CreateSetDialog)
    {
        ...
        ConplanarCheckBox = new QCheckBox(CreateSetDialog);
        ConplanarCheckBox->setObjectName(QString::fromUtf8("ConplanarCheckBox"));
        ConplanarCheckBox->setMinimumSize(QSize(0, 25));
        ConplanarCheckBox->setMaximumSize(QSize(16777215, 25));
        ConplanarCheckBox->setChecked(true);

        gridLayout_2->addWidget(ConplanarCheckBox, 2, 0, 1, 2);
    ...
    void retranslateUi(QDialog *CreateSetDialog)
    {
        ...
        ConplanarCheckBox->setToolTip(QString());
#endif // QT_CONFIG(tooltip)
        ConplanarCheckBox->setText(QCoreApplication::translate("CreateSetDialog", "Find Conplanar Points or Cells", nullptr));
