...
struct qt_meta_stringdata_SARibbonPannelLayout_t {
    QByteArrayData data[1];
    char stringdata0[21];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SARibbonPannelLayout_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SARibbonPannelLayout_t qt_meta_stringdata_SARibbonPannelLayout = {
    {
QT_MOC_LITERAL(0, 0, 20) // "SARibbonPannelLayout"
...
static const uint qt_meta_data_SARibbonPannelLayout[] = {
...
QT_INIT_METAOBJECT const QMetaObject SARibbonPannelLayout::staticMetaObject = { {
    QMetaObject::SuperData::link<QLayout::staticMetaObject>(),
    qt_meta_stringdata_SARibbonPannelLayout.data,
    qt_meta_data_SARibbonPannelLayout,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_SARibbonPannelLayout.stringdata0))
        return static_cast<void*>(this);
