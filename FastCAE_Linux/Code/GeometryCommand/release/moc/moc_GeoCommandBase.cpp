...
QT_MOC_LITERAL(12, 166, 17), // "updatePropertySig"
QT_MOC_LITERAL(13, 184, 23), // "DataProperty::DataBase*"
QT_MOC_LITERAL(14, 208, 4) // "data"
    ...
    "updateActions\0updatePropertySig\0"
    "DataProperty::DataBase*\0data"
};
...
void Command::GeoCommandBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 7: _t->updatePropertySig((*reinterpret_cast< DataProperty::DataBase*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (GeoCommandBase::*)(DataProperty::DataBase * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GeoCommandBase::updatePropertySig)) {
                *result = 7;
                return;
            }
        }
...
// SIGNAL 7
void Command::GeoCommandBase::updatePropertySig(DataProperty::DataBase * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
